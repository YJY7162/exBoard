	...
	// 	let inputFile = jQuery3_6_0("#uploadInputBox")[0].files;
	//
	...
	function onAjaxError (){
 	...
 	function callFileUploader (){
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
 			sUrl  : '/multiImageUploader',	//샘플 URL입니다.
 	        sCallback : '/smartEditor/js/sample/photo_uploader/callback.html',	//업로드 이후에 iframe이 redirect될 콜백페이지의 주소
